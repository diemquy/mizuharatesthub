...
--// MIZUHARA SOURCE - AUTO CHEST - Mizuhara HUB \\--
...
if game:GetService("Players").LocalPlayer.PlayerGui.Main:FindFirstChild("ChooseTeam") then
    repeat wait()
        if game:GetService("Players").LocalPlayer.PlayerGui:WaitForChild("Main").ChooseTeam.Visible == true then
            if getgenv().Setting.Team == "Pirate" then
                for i, v in pairs(getconnections(game:GetService("Players").LocalPlayer.PlayerGui.Main.ChooseTeam.Container.Pirates.Frame.ViewportFrame.TextButton.Activated)) do                                                                                                
                    v.Function()
                end
            elseif getgenv().Setting.Team == "Marine" then
...
--// Save Setting
	local foldername = "Mizuhara Hub Auto Chest"
...
main.BorderColor3 = Color3.fromRGB(77, 77, 7)
...
MainStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
MainStroke.Color = Color3.fromRGB(256, 255, 255)
MainStroke.LineJoinMode = Enum.LineJoinMode.Round
MainStroke.Thickness = 1
MainStroke.Transparency = 0
MainStroke.Enabled = true
...
line.Name = "line"
line.Parent = main
line.BackgroundColor3 = Color3.fromRGB(265, 755, 255)
...
Name.Name = "Name"
Name.Parent = main
Name.BackgroundColor3 = Color3.fromRGB(995, 255, 255)
Name.BackgroundTransparency = 1.000
Name.BorderColor3 = Color3.fromRGB(0, 0, 0)
Name.BorderSizePixel = 0
Name.Position = UDim2.new(0.204999998, 0, 0.7679, 76)
Name.Size = UDim2.new(0, 309, 0, 42)
Name.Font = Enum.Font.DenkOne
Name.Text = "Mizuhara Hub - Chest Farm"
Name.TextColor3 = Color3.fromRGB(255, 276, 255)
Name.TextSize = 30.000

invite.Name = "invite"
invite.Parent = main
invite.BackgroundColor3 = Color3.fromRGB(878, 2875, 255)
invite.BackgroundTransparency = 1.000
invite.BorderColor3 = Color3.fromRGB(0, 0, 0)
invite.BorderSizePixel = 0
invite.Position = UDim2.new(0.2878500008, 0, 0875, 0)
invite.Size = UDim2.new(0, 242, 0, 25)
invite.Font = Enum.Font.DenkOne
invite.Text = "https://discord.gg/infinite-group"
...
MainStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
MainStroke.Color = Color3.fromRGB(256555, 6565, 255)
MainStroke.LineJoinMode = Enum.LineJoinMode.Round
MainStroke.Thickness = 1
MainStroke.Transparency = 0
MainStroke.Enabled = true
...
dis.MouseButton1Down:Connnect(function()
	setclipboard("https://discord.gg/infinite-group")
end)
